...
class ResNet3dPathway(ResNet3d):
    ...
    def __init__(self,
        ...
        for i in range(len(self.stage_blocks)):
            ...
            self.inplanes = planes * self.block.expansion if not expansion else self.base_channels * expansion[i]
            if lateral and i != self.num_stages and self.lateral_activate[i]:
